...
export default function BillingPage() {
  ...
  const [activeTab, setActiveTab] = useState<"dashboard" | "packages">(
    "dashboard"
  );
  ...
  const [pkgCycle, setPkgCycle] = useState<"monthly" | "quarterly" | "annual">(
    "monthly"
  );
  ...
  const monthlyData = Object.values(
    invoices.reduce(
      (acc, inv) => {
        ...
        acc[key].expenses +=
          (inv.status === "paid" ? inv.total : inv.total * 0.5) * 0.45;
  ...
  const statusData = [
    ...
    {
      name: "Outstanding",
      value: invoices.filter(i => i.status === "sent" || i.status === "overdue")
        .length,
      color: "#66B2B2",
    },
    {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-0.5">
            Invoices, packages &amp; revenue analytics
          </p>
        </div>
        {!isClient && (
          <Button
            onClick={() => setShowCreator(true)}
            className="bg-[#66B2B2] text-white font-bold h-9"
          >
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            <div className="data-card p-4 laser-scan">
              ...
              <div className="text-4xl font-bold text-black kpi-glow">
            ...
            <div className="data-card p-4">
              ...
              <div className="text-4xl font-bold text-[#66B2B2]">
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                {filteredInvoices.map(invoice => {
                  ...
                  const client = (seedData.clients as any[]).find(
                    c => c.id === seedClientId
                  );
                  return (
                    <tr
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredPackages.map(pkg => {
            ...
            return (
              <div
                key={pkg.id}
                className="data-card p-5 border-t-4 border-[#66B2B2] flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="space-y-2.5 mb-6">
                    ...
                    <div className="flex items-center gap-2 text-xs text-black">
                      ...
                      <span>
                        {pkg.visitsRemaining} / {pkg.totalVisits} Visits
                        Remaining
                      </span>
                    </div>
                    <div className="flex items-center gap-2 text-xs text-black">
                ...
                <div className="pt-4 border-t border-gray-200 flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xl font-bold text-[#66B2B2] font-mono-tech">
          ...
          <div className="relative z-10 w-full max-w-2xl bg-white border border-gray-200 rounded-lg shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      Define a new maintenance or subscription plan
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <label className="text-[10px] text-gray-600 uppercase font-bold mb-1.5 block">
                      Package Name
                    </label>
                    <Input
                      value={pkgName}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="bg-white border-gray-200 text-black placeholder:text-gray-500 h-20 resize-none"
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select
                        value={pkgTier}
                        onValueChange={v => setPkgTier(v as any)}
                      >
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        value={pkgVisits}
                        onChange={e => setPkgVisits(e.target.value)}
                        type="number"
                        placeholder="4"
                        className="bg-white border-gray-200 text-black placeholder:text-gray-500"
                      />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="PMS, Calibration, Tech Support"
                      className="bg-white border-gray-200 text-black placeholder:text-gray-500"
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Legal terms or SLA details..."
                  className="bg-white border-gray-200 text-black placeholder:text-gray-500 h-16 resize-none"
                />
              </div>
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-200">
                ...
                <Button
                  ...
                  className="flex-1 bg-[#66B2B2] text-white font-bold"
                >
                  Create Package
                </Button>
              </div>
