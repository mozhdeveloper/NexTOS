...
import type { ScheduledMaintenanceEntry } from "../service.types";
        ...
        <table className="w-full text-xs">
          ...
          <tbody>
            {allScheduledMaintenance.map(entry => {
              const _seedEq = liveEquipment.find(
                e => e.id === entry.equipmentId
              );
              const nextService = _seedEq
                ? computeNextService(
                    {
                      serviceInterval: entry.serviceInterval,
                      serviceIntervalUnit: entry.serviceIntervalUnit,
                    },
                    _seedEq
                  )
                : "—";
              const statusDef = seedData.pmsStatuses.find(
              ...
              return (
                ...
                >
                  ...
                  <td className="py-2.5 px-3 text-black font-mono">
                    {entry.serviceInterval}
                  </td>
                  <td className="py-2.5 px-3 text-gray-600">
                    {entry.serviceIntervalUnit}
                  </td>
                  <td className="py-2.5 px-3 text-black">
                  ...
                  <td className="py-2.5 px-3">
                    {statusDef ? (
                      <span
                        ...
                        style={{
                          backgroundColor: `${statusDef.color}33`,
                  ...
                  <td className="py-2.5 px-3 font-mono-tech text-xs text-gray-700">
                    {nextService}
                  </td>
                  <td className="py-2.5 px-3">
            ...
            {allScheduledMaintenance.length === 0 && (
              <tr>
                <td colSpan={10} className="py-10 text-center text-gray-400">
                  No scheduled maintenance entries. Click "+ Schedule Service"
                  to add one.
                </td>
              </tr>
            )}
        ...
        <DialogContent className="bg-white border border-gray-200 max-w-md">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={v => {
                  ...
                  setScheduleMissingFields(p =>
                    p.filter(f => f !== "equipment")
                  );
                  const taken = new Set(
                    allScheduledMaintenance
                  ...
                  const firstAvailable = PM_INTERVAL_UNITS.find(
                    u => !taken.has(u.toLowerCase())
                  );
                  if (firstAvailable) setScheduleIntervalUnit(firstAvailable);
                }}
              >
                <SelectTrigger
                  className={`w-full bg-white text-black ${scheduleMissingFields.includes("equipment") ? "border-[#EF4444]" : "border-gray-200"}`}
                >
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={v => {
                  ...
                  setScheduleMissingFields(p =>
                    p.filter(f => f !== "serviceType")
                  );
                }}
              >
                <SelectTrigger
                  className={`w-full bg-white text-black ${scheduleMissingFields.includes("serviceType") ? "border-[#EF4444]" : "border-gray-200"}`}
                >
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={e => {
                    ...
                    setScheduleMissingFields(p =>
                      p.filter(f => f !== "serviceInterval")
                    );
                  }}
                  placeholder="e.g. 500"
                  className={`bg-white text-black placeholder:text-gray-400 ${scheduleMissingFields.includes("serviceInterval") ? "border-[#EF4444]" : "border-gray-200"}`}
                />
              </div>
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={setScheduleIntervalUnit}
                >
                    ...
                    {(() => {
                      ...
                      return PM_INTERVAL_UNITS.map(u => (
                        <SelectItem
                          key={u}
                          value={u}
                          disabled={takenUnitsForAdd.has(u.toLowerCase())}
                        >
                          {u}
                        </SelectItem>
                      ));
          ...
          <div className="flex justify-end gap-2 pt-2">
            <Button
              ...
              disabled={addPmsPending}
            >
              Cancel
            </Button>
            <Button
              onClick={handleScheduleSubmit}
              className="bg-[#66B2B2] text-black hover:bg-[#66B2B2]/90 font-semibold"
              disabled={addPmsPending}
            >
              {addPmsPending ? "Saving…" : "Schedule →"}
            </Button>
          </div>
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="bg-white border border-gray-200 max-w-md">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={v => {
                  ...
                  setEditMissingFields(p => p.filter(f => f !== "equipment"));
                }}
              >
                <SelectTrigger
                  className={`w-full bg-white text-black ${editMissingFields.includes("equipment") ? "border-[#EF4444]" : "border-gray-200"}`}
                >
                  <SelectValue placeholder="Select equipment" />
                </SelectTrigger>
                <SelectContent className="bg-white border-gray-200">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={v => {
                  ...
                  setEditMissingFields(p => p.filter(f => f !== "serviceType"));
                }}
              >
                <SelectTrigger
                  className={`w-full bg-white text-black ${editMissingFields.includes("serviceType") ? "border-[#EF4444]" : "border-gray-200"}`}
                >
                  <SelectValue placeholder="Select service type" />
                </SelectTrigger>
                <SelectContent className="bg-white border-gray-200">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={e => {
                    ...
                    setEditMissingFields(p =>
                      p.filter(f => f !== "serviceInterval")
                    );
                  }}
                  placeholder="e.g. 500"
                  className={`bg-white text-black placeholder:text-gray-400 ${editMissingFields.includes("serviceInterval") ? "border-[#EF4444]" : "border-gray-200"}`}
                />
              </div>
              <div className="space-y-1.5">
                <Label className="text-sm text-black font-medium">Unit</Label>
                <Select
                  ...
                  onValueChange={setEditIntervalUnit}
                >
                  <SelectTrigger className="w-full bg-white border-gray-200 text-black">
                    <SelectValue />
                  </SelectTrigger>
                    ...
                    {(() => {
                      ...
                      return PM_INTERVAL_UNITS.map(u => (
                        <SelectItem
                          key={u}
                          value={u}
                          disabled={takenUnitsForEdit.has(u.toLowerCase())}
                        >
                          {u}
                        </SelectItem>
                      ));
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button
              ...
              disabled={updatePmsPending}
            >
              {updatePmsPending ? "Saving…" : "Save Changes"}
            </Button>
          </div>
        </DialogContent>
      </Dialog>
