...
import { useMarketingStore } from "@/features/marketing/useMarketingStore";
...
export default function Marketing() {
  ...
  const marketingLeads = leads.filter(
    l => l.source === "Marketing Landing Page" || l.source === "Email Campaign"
  );
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Campaign performance & lead attribution
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-3">
        ...
        <div className="data-card p-4">
          ...
          <div className="text-3xl font-bold text-[#66B2B2] font-mono-tech">
        ...
        <div className="data-card p-4">
          ...
          <div className="text-3xl font-bold text-[#10B981] font-mono-tech">
            {totalLeads}
          </div>
          <div className="text-[10px] text-gray-500 mt-1">
        ...
        <div className="data-card p-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 rounded bg-gray-50 border border-gray-200">
              ...
              <span className="text-[9px] font-bold text-gray-500 border border-gray-200 px-1.5 py-0.5 rounded">
                READY
              </span>
            </div>
            <div className="flex items-center justify-between p-3 rounded bg-gray-50 border border-gray-200">
            ...
            <div className="mt-6 p-3 rounded bg-[#66B2B2]/5 border border-[#66B2B2]/20">
              ...
              <p className="text-[10px] text-gray-500 leading-relaxed">
                Gateways are pre-configured. Real API keys can be connected in
                the System Settings under "Integrations".
              </p>
            </div>
          </div>
        </div>
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="bg-gray-50">
              <th className="text-left py-3 px-4 text-gray-500 font-medium uppercase tracking-wider text-[10px]">
                Campaign Name
              </th>
              <th className="text-left py-3 px-4 text-gray-500 font-medium uppercase tracking-wider text-[10px]">
                Type
          ...
          <tbody>
            {campaigns.map(c => (
              ...
              >
                ...
                <td className="py-3 px-4 font-mono-tech text-gray-900">
                ...
                <td className="py-3 px-4">
                  <div className="w-24 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min((c.leadsGenerated / 20) * 100, 100)}%`,
                      }}
                    />
                  </div>
                </td>
