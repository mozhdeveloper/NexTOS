...
import { History, ChevronDown, ChevronUp, Wrench, Search, Camera } from "lucide-react";
  ...
  return (
    <div className="space-y-4 px-8 pt-8">
      ...
      <div className="relative max-w-xs">
        ...
        <Input
          placeholder="Search by unit, type, technician…"
          value={search}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className={`px-1.5 py-0.5 rounded text-[10px] font-medium capitalize ${serviceTypeColors[record.serviceType] ?? "bg-[#88888C]/20 text-[#88888C]"}`}>
                        {record.serviceType}
                      </span>
              ...
              {isExpanded && (
                <div className="px-6 pb-5 border-t border-white/5 pt-4 space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                    <div>
                      <div className="text-[10px] text-[#88888C] uppercase tracking-wider mb-0.5">Equipment</div>
                      <div className="text-[#EAEAEA] font-mono-tech">{eq?.serialNumber ?? "—"}</div>
                    </div>
                    <div>
                      <div className="text-[10px] text-[#88888C] uppercase tracking-wider mb-0.5">Service Hours</div>
                  ...
                  {/* Description */}
                  <div>
                    <div className="text-[10px] text-[#88888C] uppercase tracking-wider mb-1">Description</div>
