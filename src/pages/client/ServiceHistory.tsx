...
import { ServiceHistoryFilters } from "@/components/client/service-history/ServiceHistoryFilters";
import { ServiceHistoryStats } from "@/components/client/service-history/ServiceHistoryStats";
import { ServiceHistoryTable } from "@/components/client/service-history/ServiceHistoryTable";
import { ServiceRecordDetailsModal } from "@/components/client/service-history/ServiceRecordDetailsModal";
import {
  filterServiceHistoryRecords,
  mapServiceRecordsToClientAccounts,
  summarizeServiceHistory,
} from "@/components/client/service-history/serviceHistoryData";
import type {
  ServiceHistoryFilters as Filters,
  ServiceHistoryRecord,
} from "@/components/client/service-history/types";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            {new Set(clientRecords.map((record) => record.equipmentId)).size} equipment units · {filteredRecords.length} matching service records
          </p>
        </div>
      </div>
