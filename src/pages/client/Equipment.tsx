...
function KPICard({ title, value, subtext, icon: Icon, colorClass, iconBgClass }: {
  ...
  return (
    <div className="group relative overflow-hidden rounded-lg bg-[#1A1A1A]/80 backdrop-blur-md border border-white/10 p-4 transition-all duration-300 hover:border-[#10B981]/50 hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(16,185,129,0.1)]">
