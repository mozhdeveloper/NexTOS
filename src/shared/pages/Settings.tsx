    ...
    <div className="space-y-4 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-0.5">
          Configure your NexTOS instance
        </p>
      </div>
      ...
      <div className="data-card p-4 bg-white shadow-sm border border-gray-200">
        ...
        <div className="space-y-3">
          {[
            {
              label: "Email alerts for overdue tasks",
              desc: "Get notified when tasks become overdue",
            },
            {
              label: "Service due reminders",
              desc: "Notifications when equipment needs maintenance",
            },
            {
              label: "New lead notifications",
              desc: "Alert when a new lead is added",
            },
            {
              label: "Invoice status updates",
              desc: "Get notified on payment received",
            },
          ].map((item, idx) => (
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="outline"
              size="sm"
              className="h-7 text-[10px] border-gray-200 text-gray-600"
            >
              Enable
            </Button>
          </div>
