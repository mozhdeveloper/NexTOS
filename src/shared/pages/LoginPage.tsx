  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 flex items-center justify-center relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 30% 50%, rgba(102,178,178,0.06) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1 font-mono-tech">
            Security & Management Intelligence Platform
          </p>
        </div>
                ...
                >
                  <div
                    className={`w-9 h-9 rounded flex items-center justify-center ${
                      isSelected ? "bg-[#66B2B2]" : "bg-gray-100"
                    }`}
                  >
                    <role.icon
